...
class CurriculosControllerTest < ActionController::TestCase
  ...
  test "should create curriculo" do
    assert_difference('Curriculo.count') do
      post :create, curriculo: { codigo: @curriculo.codigo, curso_id: @curriculo.curso_id, disciplina_id: @curriculo.disciplina_id }
    end
  ...
  test "should update curriculo" do
    patch :update, id: @curriculo, curriculo: { codigo: @curriculo.codigo, curso_id: @curriculo.curso_id, disciplina_id: @curriculo.disciplina_id }
    assert_redirected_to curriculo_path(assigns(:curriculo))
  end
