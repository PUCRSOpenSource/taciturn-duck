...
disciplina_list.each do |disciplina|
	...
	Turma.create(horario: "3JK5JK", numero: 128, disciplina_i: disc.id)
	Turma.create(horario: "3JK5JK", numero: 138, disciplina_i: disc.id)	
	Turma.create(horario: "2JK4JK", numero: 148, disciplina_i: disc.id)		
	Turma.create(horario: "4LM6LM", numero: 158, disciplina_i: disc.id)		
	Turma.create(horario: "2NP6NP", numero: 168, disciplina_i: disc.id)			
	Turma.create(horario: "3JK5JK", numero: 178, disciplina_i: disc.id)			
	Turma.create(horario: "7ABCD", numero: 188, disciplina_i: disc.id)		
	Turma.create(horario: "2JK3JK", numero: 198, disciplina_i: disc.id)
	Turma.create(horario: "2JK4JK6JK", numero: 228, disciplina_i: disc.id)
	Turma.create(horario: "2JK4JK6JK", numero: 238, disciplina_i: disc.id)
	Turma.create(horario: "6LMNP", numero: 248, disciplina_i: disc.id)
	Turma.create(horario: "2LM4LM", numero: 258, disciplina_i: disc.id)
	Turma.create(horario: "3NP5NP", numero: 268, disciplina_i: disc.id)	
	Turma.create(horario: "2JK6JK", numero: 278, disciplina_i: disc.id)
	Turma.create(horario: "3LM3NP", numero: 288, disciplina_i: disc.id)
	Turma.create(horario: "3LM3NP", numero: 298, disciplina_i: disc.id)
end
